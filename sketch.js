...
const PADDLE_SIZE = 1; // paddle size as a multiple of wall thickness
...
const COLOR_PADDLE = 'dodgerblue';
const COLOR_TEXT = "white";
const COLOR_WALL = "white";

// text
const TEXT_FONT = "Gill Sans";
...
function drawText() {
    ...
    if (gameOver) {
        ...
        ctx.fillRect(0, 0, width, height);
        ctx.fillStyle = "white";
        ctx.fillText(text, width * 0.5, paddle.y - (textSize*6), maxWidth);
        ctx.fillText("Press Space To Restart", width * 0.5, paddle.y - (textSize*4), maxWidth);
    }
}
